    ...
    <div className="w-full max-w-sm mx-auto" style={{ perspective: '1600px' }}>
      ...
      >
        ...
        <div
          ...
          style={{ backfaceVisibility: 'hidden', boxShadow: '0 20px 60px rgba(0,0,0,0.5)' }}
        >
          ...
          <div className="absolute inset-x-0 bottom-0 p-6 bg-gradient-to-t from-black/90 via-black/40 to-transparent">
            <p className="font-bold text-white text-lg leading-tight">Mouhamed Amine Paré</p>
            <p className="text-white/70 text-sm mt-0.5">Développeur Fullstack &amp; Créateur Digital</p>
            <p className="text-white/40 text-[10px] uppercase tracking-widest mt-3">Clique pour explorer ↻</p>
          </div>
        </div>
        ...
        <div
          ...
          style={{ backfaceVisibility: 'hidden', transform: 'rotateY(180deg)', boxShadow: '0 20px 60px rgba(0,0,0,0.5)' }}
        >
